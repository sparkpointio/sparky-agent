...
<div>
    ...
    <div class="tw-pt-[88px]">
        <div class="py-5 position-relative">
            <div class="position-absolute w-100 tw-left-[0] tw-top-[0] background-image-cover tw-bg-[url('/img/about/bg-1.webp')] tw-min-h-[calc(80vh-88px)] tw-z-[1]"></div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-11 col-xxl-10">
                        <div class="row justify-content-center align-items-stretched">
                            ...
                            <div class="col-11 col-sm-10 col-md-6 p-0 background-image-cover tw-bg-[url('/img/about/img-1.webp')] tw-min-h-[calc(100vh-88px)] sm:tw-min-h-[calc(90vh-88px)] md:tw-min-h-[initial] tw-bg-[center_top_-70px] md:tw-bg-[center_top_50%] lg:tw-bg-[center_top_-80px] xl:tw-bg-[center_top_-100px]">
    ...
    <div class="container-fluid">
        <div class="row tw-min-h-[calc(100vh-78px)] align-items-stretch">
            <div class="col-md-6 col-lg-7 background-image-cover p-0 tw-bg-[url('/img/about/img-3.webp')] tw-min-h-[calc(100vh-78px)] md:tw-min-h-[initial]"></div>
    ...
    <div class="bg-color-6">
        <div class="container-fluid">
            <div class="row tw-min-h-[calc(100vh-78px)] align-items-stretch">
                ...
                <div class="col-md-5 background-image-cover p-0 tw-bg-[url('/img/about/img-4.webp')] tw-min-h-[calc(100vh-78px)] md:tw-min-h-[initial]"></div>
            </div>
        </div>
    </div>
