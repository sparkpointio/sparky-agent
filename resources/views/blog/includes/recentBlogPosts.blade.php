<div class="container py-5">
    <div class="pt-5">
        <p class="cardo-bold text-color-1 text-center tw-tracking-[-0.05em] tw-leading-[1.1em] lg:tw-leading-[1em] xxl:tw-leading-[0.9em] font-size-200 font-size-lg-210 font-size-xl-270 px-4 px-md-0 mb-5 pb-5">Recent Blog Posts</p>
        ...
        <div class="row">
            ...
            <div class="col-md-6 pe-lg-4 pe-xl-5 mb-5">
                <a href="{{ route('blog.content', str_replace('%2F', ' ', rawurlencode($blog['title']))) }}" class="text-decoration-none">
                    ...
                    <p class="cardo-bold text-color-1 text-center tw-tracking-[-0.05em] font-size-200 font-size-lg-210 font-size-xl-270 px-4 px-md-0 mb-4">{{ $blog['title'] }}</p>
