...
@section('body')
    <h5 class="mb-4 pb-2">Your Message Has Been Sent</h5>

    <p>Dear {{ $data['name'] }},</p>

    <p>Hello, and thank you for reaching out! Our team will review your message and will get back to you as soon as we can.</p>

    <p>Depending on the amount of messages we receive, we might need more time to reply to your inquiry. We value your patience and understanding, and we are looking forward to serving you soon.</p>

    <p class="mb-0">Sincerely,</p>
    <p class="mb-0">The {{ config('app.name') }} Team</p>
@endsection
