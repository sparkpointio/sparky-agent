...
@section('body')
    <h5 class="mb-4 pb-2">New Inquiry</h5>

    <p>Dear Support Team,</p>

    <p>We have received a new message from a user seeking assistance. Please find the details below:</p>
    ...
    <p>Please take the necessary steps to address this user's inquiry as soon as possible. If you require any additional information or clarification, please reach out to the user directly using the provided email address.</p>
